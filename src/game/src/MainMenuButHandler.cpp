...
void MainMenuButHandler::render(float cameraX, float cameraY){
	cameraX = 0;
	cameraY = 0;
	this->splashSprite->render(cameraX, cameraY);
	this->hostButton->render(cameraX, cameraY);
	this->connectButton->render(cameraX, cameraY);
	this->optionsButton->render(cameraX, cameraY);
	this->creditsButton->render(cameraX, cameraY);
	this->quitButton->render(cameraX, cameraY);
