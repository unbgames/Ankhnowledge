...
Map::Map(Sprite * tile, Sprite * block, float x, float y):GameObject(x,y) {
	...
	Skill *playerSkill = new SkillDig();
	player1 = new Character(new Sprite(SDLBase::imagePath + "adam_spr.png"), tiles.at(0), playerSkill, 1);
	player2 = new Character(new Sprite(SDLBase::imagePath + "suti_spr.png"), tiles.at(columns-1), playerSkill, 2);
